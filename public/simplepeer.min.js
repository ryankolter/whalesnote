    ...
    })()(
        {
            1: [
                function (e, t, n) {
                    ...
                    function l(e) {
                        for (
                            var t, n = e.length, r = n % 3, a = [], o = 16383, d = 0, l = n - r;
                            d < l;
                            d += o
                        )
            ...
            12: [
                function (e, t) {
                    ...
                    function i() {
                        _ &&
                            f &&
                            ((_ = !1), f.length ? (g = f.concat(g)) : (h = -1), g.length && d());
                    }
                    function d() {
                        if (!_) {
                            var e = a(i);
                                    ...
                                    value: function (e) {
                                        ...
                                        for (r.data.copy(t), e -= r.data.length; (r = r.next); ) {
                                            var o = r.data,
                                                i = e > o.length ? o.length : e;
                                            if (
                                                (o.copy(t, t.length - e, 0, i), (e -= i), 0 === e)
                                            ) {
                                                i === o.length
                                                    ? (++a,
                                                      (this.head = r.next
                        ...
                        _onConnectionStateChange() {
                            this.destroyed ||
                                ("failed" === this._pc.connectionState &&
                                    this.destroy(
                                        l(new Error("Connection failed."), "ERR_CONNECTION_FAILURE")
                                    ));
                        }
                        _onIceStateChange() {
                            if (this.destroyed) return;
